# Glicemia Dexcom G5 su Apple Watch del follower con Sugarmate
...
**Sul dispositivo master** (quello con l'app Dexcom Mobile):

- Apri Dexcom G5 Mobile, tocca il triangolo in alto a destra, poi il pulsante per aggiungere un follower.
...
Torna sull'iPhone del follower nell'app Sugarmate e tocca **Fatto**. Inserisci la tua email e crea una password per il tuo account Sugarmate. Clicca **Avanti**.
