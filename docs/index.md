...
{ section: 'sensor',
  title: 'Juggluco',
  sub: 'FSL 2, FSL 3 e Dexcom G7/ONE+ con Juggluco su Android',
...
{ section: 'sensor',
  ...
  sensors: ['dexcom'],
  os: ['android'],
  href: './documentation/xdrip/dexcomg6-e-xdrip' },
{ section: 'sensor',
...
{ section: 'sensor',
  ...
  sensors: ['dexcom'],
  os: ['android'],
  href: './documentation/xdrip/dexcom-g6-g7-app-modificata' },
{ section: 'sensor',
...
{ section: 'watch',
  ...
  os: ['android'],
  status: 'archived',
  href: './documentation/xdrip/mi-band234-con-xdrip' },
{ section: 'watch',
...
{ section: 'watch',
  ...
  sub: 'Quadranti e app per smartwatch Wear OS',
  sensors: ['dexcom','libre'],
  os: ['android'],
  href: './documentation/wearos/glicemia-su-smartwatch-wear-os' },
{ section: 'watch',
  title: 'Fitbit ⚠',
...
{ section: 'watch',
  ...
  os: ['android','ios'],
  status: 'archived',
  href: './documentation/fitbit/sentinel-pro-userguide1',
  warn: true },
{ section: 'watch',
  title: 'Sentinel One ⚠',
  ...
  os: ['android','ios'],
  status: 'archived',
  href: './documentation/fitbit/sentineloneuserguide1',
  warn: true },
{ section: 'watch',
...
{ section: 'tool',
  ...
  sub: 'Display M5Stack per Nightscout, Dexcom, LLink o xDrip',
  sensors: ['dexcom','libre','medtronic'],
  os: ['android','ios'],
...
{ section: 'tool',
  ...
  sub: 'Guida obsoleta: skill Alexa di Sugarmate dismessa a gennaio 2025',
  sensors: ['dexcom','libre'],
  os: ['android'],
  status: 'archived',
  href: './documentation/alexa-siri/alexa-con-app-dexcom-o-xdrip',
  warn: true },
{ section: 'tool',
  title: 'Siri e Nightscout ⚠',
  sub: 'La scorciatoia originale non è più disponibile',
  sensors: ['dexcom','libre','medtronic'],
  os: ['ios'],
  status: 'archived',
